...
\newline
4-une fois trouver il lui passe le nom des taches qu'il doit executer  ainsi que le Job
\newline
5-une fois terminer il mette la valeur de retour sur Taskmaster et décrémente un cpt des que celui ci est a 0 le client est libre de recupérér sont Job
\newline
\newline
